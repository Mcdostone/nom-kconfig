...
**Features**
 ...
 - There are cargo features for `glob-wildcard` (used by coreboot, for example) and `kconfiglib` compatibility. Enabling them adds support for some non-standard entries and attributes used by these projects.
